...
class TensorBase(metaclass=_TensorMeta):
    ...
    @overload
    def new_ones(self, size: _size, dtype: Optional[_dtype] = None, device: Device = None, requires_grad: _bool = False, pin_memory: _bool = False) -> Tensor: ...
    @overload
    ...
    def new_tensor(self, data: Any, dtype: Optional[_dtype] = None, device: Device = None, requires_grad: _bool = False, pin_memory: _bool = False) -> Tensor: ...
    @overload
